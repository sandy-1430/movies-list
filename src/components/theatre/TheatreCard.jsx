...
export default function TheatreCard({theatres}) {
    return (
        <>
            {theatres?.map((item)=>(
                <div className="card" key={item.theatre_name}>
                    <figure>
                        <img src={item.thumbnail_url} alt={item.theatre_name} />
                    </figure>                    
                    <div className="details">
                        <p className="cardTitle">{item.theatre_name}</p>
                        <p className="rating">
                        ...
                        <Link to={`/theatre-detail/${item.theatre_name.split(" ").join("-")}`} className="readMore">
                            More Details
                        </Link>
                    </div>
                </div>
